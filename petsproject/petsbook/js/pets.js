...
function readbook(bookid){
	window.location ="http://qr.bookln.cn?_appbiz=clickread&bookid="+bookid+"&srcchannel=h5petsread";
}
function buybook(clickbookid){
	window.location ="http://bookln.cn?_appbiz=buy&biztype=8&bizid="+clickbookid+"&srcchannel=h5petsbuy";
}
function watchlesson(bookid){
	window.location ="http://qr.bookln.cn?_appbiz=bookdetail&bookid="+bookid+"&srcchannel=h5pets";
}